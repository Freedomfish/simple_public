...
{
public:
    virtual bool Exec(void *parmer){return false;}
};
...
protected:
    ...
    virtual bool FitCondition(T& pre_cond, T& new_cond){return false;}
private:
//标识 - FilterUtil
...
public:
    virtual bool FitCondition(std::string& pre_url, std::string& new_url)
    {
        ...
        else new_url += pre_url.substr(new_url.length(), pos+1);
